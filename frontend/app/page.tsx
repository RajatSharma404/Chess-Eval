...
import { Search, Loader2, Play, Sparkles, ArrowRight } from 'lucide-react';
  ...
  return (
    <main className="h-screen w-full bg-[#050505] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl w-full text-center space-y-6 z-10">
        ...
        <form onSubmit={handleAnalyze} className="relative group max-w-2xl mx-auto mt-4">
          ...
          <div className="relative bg-gray-900/80 backdrop-blur-2xl border border-white/10 rounded-2xl p-2 sm:p-3 flex flex-col sm:flex-row items-center shadow-3xl">
            ...
            <button 
              type="submit"
              className="w-full sm:w-auto mt-2 sm:mt-0 bg-white text-black px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-black uppercase tracking-widest text-sm hover:bg-emerald-400 hover:text-white transition-all flex items-center justify-center gap-2 group/btn"
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 opacity-30 mt-8 mb-2">
           <div className="flex items-center gap-2 sm:gap-3 grayscale hover:grayscale-0 transition-all cursor-default">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-lg flex items-center justify-center"><div className="w-3 h-3 sm:w-4 sm:h-4 bg-black rotate-45"></div></div>
              <span className="text-white font-black text-xs sm:text-sm uppercase tracking-widest">Lichess</span>
           </div>
           <div className="flex items-center gap-2 sm:gap-3 grayscale hover:grayscale-0 transition-all cursor-default">
              <svg viewBox="0 0 100 100" className="w-6 h-6 sm:w-8 sm:h-8 fill-[#81b64c]"><path d="M96.4,32.2c-0.8-2.6-3.1-4.3-5.8-4.3H74.3c-1.3,0-2.5,0.5-3.4,1.4l-11,11c-0.9,0.9-1.4,2.1-1.4,3.4v16.3c0,1.3,0.5,2.5,1.4,3.4l11,11c0.9,0.9,2.1,1.4,3.4,1.4h16.3c2.7,0,5-1.7,5.8-4.3c0.8-2.6,0.1-5.4-1.8-7.3l-11-11c-0.9-0.9-1.4-2.1-1.4-3.4s0.5-2.5,1.4-3.4l11-11C96.3,37.6,97.1,34.8,96.4,32.2z"/></svg>
              <span className="text-[#81b64c] font-black text-xs sm:text-sm uppercase tracking-widest">Chess.com</span>
           </div>
        </div>

        <div className="hidden sm:grid grid-cols-2 gap-6 w-full max-w-4xl mx-auto mt-4 text-left relative z-10 scale-90 origin-top">
